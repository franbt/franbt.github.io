...
const landmarks = [
    ...
    { name: "Abrevaderos del Vadillo", apunt: "Abrevaderos", desc: "Los Abrevaderos del Vadillo son sencillos pilares de piedra ubicados en la antigua entrada norte de la ciudad de Cáceres, junto al cauce del arroyo de la Madre y a escasos metros del antiguo Puente de Vadillo.  Estos abrevaderos servían para dar de beber directamente al ganado, una práctica prohibida en el resto de fuentes públicas de la Ribera del Marco para evitar la contaminación del agua destinada al consumo humano.", titu: "Municipal", type: "Abrevaderos", target: { x: 515, y: 20, z: -1165 }, offset: { x: 0, y: 15, z: 30 }, zoom: 3 }
];
