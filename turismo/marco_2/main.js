...
const landmarks = [
    { name: "Charca del Marco", apunt: "Origen del caudal de la Rivera del Marco", desc: "También llamada 'Fuente del Rey', procede de la filtración de agua del Calerizo y llega a través de un sifón natural. Sus aguas transcurren de sureste a noreste por la Ribera.", titu: "Municipal", type: "Acuífero", target: { x: 430, y: 0, z: 1223 }, offset: { x: 0, y: 0, z: 0 }, zoom: 3 },
